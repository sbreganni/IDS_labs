...
ggplot(penguins, aes(x = flipper_length_mm, 
  ...
  geom_point() +
  theme_minimal() +
  labs(title = "Better plot",
       x = "flipper length in millimiters",
       y = "penguin mass in grams",
       color = "Species") 
...
#it's important to choose the right amount of bins to make the graph make sense and also get the right takeaways
```
...
# other way to get a single trend line:
