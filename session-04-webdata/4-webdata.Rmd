...
```{r, echo=FALSE}
# Your code here
sum(str_detect(stringr::words, "ise"))
...
# the regex means:
# Match a sequence of at least 2 characters ({2,}),
# where each character in the sequence is one of the following:
## A letter (uppercase or lowercase) → [:alpha:]
## A period (.)
## A comma (,)
## A space ( )
```
...
str_extract_all(emails, "(^[0-9]+|^[:alpha:]\\.[:alpha:]+)@.+")
```
